...
var RetrieveParams = typebox_exports.Object({
  hash: typebox_exports.String({
    description: 'The hash from a headroom compression marker (e.g. "[headroom hash=...]" or "Retrieve more: hash=...").'
  })
});
function makeRetrieveTool(getConfig) {
  return {
    name: "headroom_retrieve",
    label: "Headroom Retrieve",
    description: "Retrieve the original content of a mechanically compressed tool output by its hash. Use when a compressed result is marked with a headroom hash and the current step needs the missing detail.",
